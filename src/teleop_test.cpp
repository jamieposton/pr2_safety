...
private:
  ...
  ros::NodeHandle nh_;
  //! We will be publishing to the "/base_controller/command" topic to issue commands to the base
...
public:
  ...
  pr2_controllers_msgs::JointTrajectoryGoal armExtensionTrajectory()
  {
    ...
    goal.trajectory.points[ind].positions[1] = -5.0;
    goal.trajectory.points[ind].positions[2] = -3.0; //Shouldn't change
    goal.trajectory.points[ind].positions[3] = -0.7;
    goal.trajectory.points[ind].positions[4] = 3.0; //Shouldn't change
    goal.trajectory.points[ind].positions[5] = 2.0;
    goal.trajectory.points[ind].positions[6] = -0.5; //Shouldn't change
    // Velocities
  ...
  //! Loop forever while sending drive commands
  bool moveit(pr2_controllers_msgs::JointTrajectoryGoal goal)
  {
			cout << "Test Running.\n";
...
int main(int argc, char** argv)
{
  ...
  driver.moveit(driver.armExtensionTrajectory());
